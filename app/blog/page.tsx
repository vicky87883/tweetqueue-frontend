...
import { ArrowLeft, ChevronLeft, ChevronRight, Clock, FileText, Search } from 'lucide-react';
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              ...
              <h1 className="text-balance text-4xl font-bold sm:text-6xl">
                X and Twitter posting guides for creators
              </h1>
            </div>
            <p className="max-w-2xl text-base leading-relaxed text-gray-400 sm:text-lg">
              Practical guides for how to tweet, schedule posts, write threads, build a
              content calendar, and improve every batch with analytics.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-8 sm:px-6 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <Link
            ...
            className="card group grid overflow-hidden rounded-3xl lg:grid-cols-[0.92fr_1.08fr]"
          >
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="mb-5 flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center gap-2 rounded-full bg-zinc-900 px-3 py-1.5 text-sm text-[#1DA1F2]">
              ...
              <h2 className="mb-4 text-balance text-3xl font-bold group-hover:text-[#1DA1F2] sm:text-5xl">
                {featured.title}
              </h2>
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-5 text-center sm:text-left lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-400">
              Create your account and start organizing the next week of posts.
            </p>
          </div>
          <Link
            href="/register"
